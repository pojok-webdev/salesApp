      ...
      <div class="modal-body">
          <form role="form">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="actdate" placeholder="Tanggal">
            </div>
            <div class="form-group">
              <label for="psw"><span class="glyphicon glyphicon-user"></span> PIC Pelanggan</label>
              <input type="text" class="form-control" id="psw" placeholder="PIC Pelanggan">
            </div>
            <div class="form-group">
              <label for="psw"><span class="glyphicon glyphicon-eye-open"></span> Jenis Kegiatan</label>
              <input type="text" class="form-control" id="psw" placeholder="Jenis Kegiatan">
            </div>
            <div class="form-group">
              <label for="psw"><span class="glyphicon glyphicon-eye-open"></span> Detail Kegiatan</label>
              <input type="text" class="form-control" id="psw" placeholder="Detail Kegiatan">
            </div>
            <div class="form-group">
              <label for="psw"><span class="glyphicon glyphicon-user"></span> Sales</label>
              <input type="text" class="form-control" id="psw" placeholder="Sales">
            </div>
          </form>
